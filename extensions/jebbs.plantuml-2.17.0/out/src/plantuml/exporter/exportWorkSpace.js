...
function exportWorkSpace(...para) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let files;
        if (para.length == 1) {
            files = yield getFileList(para[0]);
        }
        else {
            files = yield getFileList(para[1]);
        }
        ...
        if (hasEmptyFormat) {
            let userPickFormat = yield vscode.window.showQuickPick(appliedRender_1.appliedRender(files[0].uri).formats(), {
