...
exports.SourceControlManager = void 0;
...
class SourceControlManager {
    ...
    async enable() {
        ...
        const onPossibleSvnRepositoryChange = util_1.filterEvent(onWorkspaceChange, uri => uri.scheme === "file" && !this.getRepository(uri));
