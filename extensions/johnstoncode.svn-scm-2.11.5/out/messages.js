...
exports.inputCommitMessage = exports.dispose = exports.noChangesToCommit = void 0;
...
async function inputCommitMessage(message, promptNew = true, filePaths) {
    ...
    const checkEmptyMessage = configuration_1.configuration.get("commit.checkEmptyMessage", true);
