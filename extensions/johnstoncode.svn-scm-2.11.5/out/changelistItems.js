...
exports.getPatchChangelist = exports.patchChangelistOptions = exports.inputCommitFiles = exports.inputCommitChangelist = exports.inputSwitchChangelist = exports.getCommitChangelistPickOptions = exports.getChangelistPickOptions = void 0;
...
const fileItem_1 = require("./quickPickItems/fileItem");
...
async function inputCommitFiles(repository) {
    ...
    if (choice.id === "changes" &&
        ...
        const selectedAll = configuration_1.configuration.get("commit.changes.selectedAll", true);
        const picks = choice.resourceGroup.resourceStates.map(r => new fileItem_1.FileItem(repository, r, selectedAll));
...
exports.inputCommitFiles = inputCommitFiles;
