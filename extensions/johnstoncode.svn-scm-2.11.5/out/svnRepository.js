...
const infoParser_1 = require("./parser/infoParser");
const listParser_1 = require("./parser/listParser");
const logParser_1 = require("./parser/logParser");
const statusParser_1 = require("./parser/statusParser");
const util_1 = require("./util");
const diffParser_1 = require("./parser/diffParser");
class Repository {
    ...
    async show(file, revision) {
        ...
        if (textDocument) {
            ...
            const svnEncoding = configuration_1.configuration.get("default.encoding");
            if (svnEncoding) {
