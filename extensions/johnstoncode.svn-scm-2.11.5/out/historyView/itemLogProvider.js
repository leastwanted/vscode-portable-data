...
exports.ItemLogProvider = void 0;
...
class ItemLogProvider {
    constructor(sourceControlManager) {
        ...
        this._dispose = [];
        this._dispose.push(vscode_1.window.onDidChangeActiveTextEditor(this.editorChanged, this), vscode_1.window.registerTreeDataProvider("itemlog", this), vscode_1.commands.registerCommand("svn.itemlog.copymsg", async (item) => common_1.copyCommitToClipboard("msg", item)), vscode_1.commands.registerCommand("svn.itemlog.copyrevision", async (item) => common_1.copyCommitToClipboard("revision", item)), vscode_1.commands.registerCommand("svn.itemlog.openFileRemote", this.openFileRemoteCmd, this), vscode_1.commands.registerCommand("svn.itemlog.openDiff", this.openDiffCmd, this), vscode_1.commands.registerCommand("svn.itemlog.openDiffBase", this.openDiffBaseCmd, this), vscode_1.commands.registerCommand("svn.itemlog.refresh", this.refresh, this));
        this.refresh();
    }
    dispose() {
