...
exports.BranchChangesProvider = void 0;
...
class BranchChangesProvider {
    constructor(model) {
        ...
        this._dispose.push(vscode_1.window.registerTreeDataProvider("branchchanges", this), vscode_1.commands.registerCommand("svn.branchchanges.openDiff", this.openDiffCmd, this), vscode_1.commands.registerCommand("svn.branchchanges.refresh", () => this._onDidChangeTreeData.fire(), this), this.model.onDidChangeRepository(() => this._onDidChangeTreeData.fire()));
    }
    dispose() {
