...
exports.openFileRemote = exports.openDiff = exports.getCommitToolTip = exports.getCommitLabel = exports.getCommitDescription = exports.getCommitIcon = exports.fetchMore = exports.getLimit = exports.checkIfFile = exports.insertBaseMarker = exports.copyCommitToClipboard = exports.getIconObject = exports.transform = exports.SvnPath = exports.LogTreeItemKind = void 0;
...
function getCommitIcon(author, size = 16) {
    ...
    const gravitarUrl = configuration_1.configuration
        .get("gravatar.icon_url", "")
        .replace("<AUTHOR>", author)
        .replace("<AUTHOR_MD5>", md5(author))
        .replace("<SIZE>", size.toString());
    gravatar = vscode_1.Uri.parse(gravitarUrl);
...
async function downloadFile(repo, arg, revision) {
    ...
    return temp_svn_fs_1.tempSvnFs.createTempSvnRevisionFile(arg, revision, out);
}
...
async function openFileRemote(repo, arg, against) {
    ...
    const localUri = await temp_svn_fs_1.tempSvnFs.createTempSvnRevisionFile(arg, against, out);
    const opts = {
        preview: true
    };
