...
exports.RepositoryFilesWatcher = void 0;
...
class RepositoryFilesWatcher {
    constructor(root) {
        this.root = root;
        this.disposables = [];
        const fsWatcher = vscode_1.workspace.createFileSystemWatcher(new vscode_1.RelativePattern(util_1.fixPathSeparator(root), "**"));
