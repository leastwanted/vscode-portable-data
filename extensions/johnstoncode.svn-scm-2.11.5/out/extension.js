...
const isSvn19orGreater_1 = require("./contexts/isSvn19orGreater");
const isSvn18orGreater_1 = require("./contexts/isSvn18orGreater");
...
async function init(_context, outputChannel, disposables) {
    ...
    disposables.push(sourceControlManager, temp_svn_fs_1.tempSvnFs, new svnContentProvider_1.SvnContentProvider(sourceControlManager), new svnProvider_1.default(sourceControlManager), new repoLogProvider_1.RepoLogProvider(sourceControlManager), new itemLogProvider_1.ItemLogProvider(sourceControlManager), new branchChangesProvider_1.BranchChangesProvider(sourceControlManager), new checkActiveEditor_1.CheckActiveEditor(sourceControlManager), new openRepositoryCount_1.OpenRepositoryCount(sourceControlManager), new isSvn18orGreater_1.IsSvn18orGreater(info.version), new isSvn19orGreater_1.IsSvn19orGreater(info.version));
