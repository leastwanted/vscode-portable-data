...
async function init(_context, outputChannel, disposables) {
    ...
    const model = await new model_1.Model(svn, types_1.ConstructorPolicy.Async);
    ...
    const branchChangesProvider = new branchChangesProvider_1.BranchChangesProvider(model);
