...
function getLanguageWords() {
    let java = config_1.config.java;
    if (config_1.config.render !== config_1.RenderType.Local || !java) {
    ...
    return processWrapper_1.processWrapper(ps).then(buf => processWords(buf.toString()), () => []);
}
