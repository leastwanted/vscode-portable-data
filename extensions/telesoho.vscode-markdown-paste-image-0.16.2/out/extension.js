...
function activate(context) {
    Logger_1.default.channel = vscode.window.createOutputChannel("PasteImage");
    Logger_1.default.log('"vscode-markdown-paste" is now active!');
    ...
    context.subscriptions.push(vscode.commands.registerCommand("telesoho.MarkdownPasteCode", () => {
        paster_1.Paster.pasteCode();
    }));
}
exports.activate = activate;
function deactivate() {
    Logger_1.default.log('"vscode-markdown-paste" is now inactive!');
}
