...
![Damaged Helmet by theblueturtle_](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/DamagedHelmet.png)
...
![Install within VSCode](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/HowToInstall.png)

If you wish to build this from source code, see [Developer Environment](https://github.com/AnalyticalGraphicsInc/gltf-vscode/blob/HEAD/CONTRIBUTING.md#developer-environment).

## Export text-based `.gltf` file and all its resources to binary `.glb` file.

![GLB conversion](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/GlbConversion.png)
...
![GLB export part 1](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/ImportGlbPart1.png)

![GLB export part 2](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/ImportGlbPart2.png)
...
![Inspect Data](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/InspectData.png)
...
![Inspect Mesh Primitive](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/InspectMeshPrimitive.png)
...
![Select Vertex](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/SelectVertex.png)
...
![Select Triangles](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/SelectTriangles.png)
...
![BabylonJS Inspector](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/BabylonInspector.png)
...
![Sample validation problems](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/SampleValidationErrors.png)
...
![Sample validation icons](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/SampleValidationIcons.png)

## Convert files to and from Data URIs

![Sample conversion](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/Conversion.png)
...
![Hover tooltips](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/EmissionHover.png)
...
![Property autocomplete](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/PropertyAutocomplete.png)
...
![Render states enable](https://github.com/AnalyticalGraphicsInc/gltf-vscode/raw/HEAD/images/StatesEnable.png)
...
on [GitHub](https://github.com/AnalyticalGraphicsInc/gltf-vscode).  See [CONTRIBUTING.md](https://github.com/AnalyticalGraphicsInc/gltf-vscode/blob/HEAD/CONTRIBUTING.md).
...
Apache 2.0, see [LICENSE.md](https://github.com/AnalyticalGraphicsInc/gltf-vscode/blob/HEAD/LICENSE.md).

## Release Notes

See [CHANGELOG.md](https://github.com/AnalyticalGraphicsInc/gltf-vscode/blob/HEAD/CHANGELOG.md).
