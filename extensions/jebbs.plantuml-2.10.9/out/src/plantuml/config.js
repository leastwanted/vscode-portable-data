...
(function (IncludeSearchType) {
    IncludeSearchType[IncludeSearchType["DiagramsRoot"] = 0] = "DiagramsRoot";
    IncludeSearchType[IncludeSearchType["SourceFileDir"] = 1] = "SourceFileDir";
...
class Config extends configReader_1.ConfigReader {
    ...
    get server() {
        return this.read('server') || "https://www.plantuml.com/plantuml";
    }
    get urlFormat() {
