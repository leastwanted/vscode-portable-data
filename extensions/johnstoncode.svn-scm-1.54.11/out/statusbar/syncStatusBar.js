...
class SyncStatusBar {
    ...
    onOperationsChange() {
        ...
        this.state = Object.assign(Object.assign({}, this.state), { isStatusRemoteRunning,
            isOperationRunning,
            isSyncRunning });
    }
    onModelChange() {
        this.state = Object.assign(Object.assign({}, this.state), { remoteChangedFiles: this.repository.remoteChangedFiles });
    }
    get command() {
        let icon = "$(sync)";
        let text = "";
