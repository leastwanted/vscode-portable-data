...
class Remove extends command_1.Command {
    ...
    execute(...resourceStates) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let keepLocal;
            const answer = yield vscode_1.window.showWarningMessage("Would you like to keep a local copy of the files?.", { modal: true }, "Yes", "No");
            if (!answer) {
                return;
            }
            if (answer === "Yes") {
            ...
            yield this.runByRepository(uris, (repository, resources) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    yield repository.removeFiles(paths, keepLocal);
                }
                catch (error) {
                    console.log(error);
